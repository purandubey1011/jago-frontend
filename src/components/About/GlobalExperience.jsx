...
const GlobalExperienceSection = () => {
  ...
  return (
    <section className="h-[95vh] w-[100vw] overflow-hidden py-0 bg-white">
      <div className="relative w-full max-w-6xl px-4 md:px-0  mx-auto">
        ...
        {/* Popup 1 */}
        <motion.div
          className="ge-popup absolute top-[47vh] left-1/2 -translate-x-1/2 -translate-y-1/2 
             bg-[#f9fbea]/50 md:bg-[#f9fbea]/80 rounded-lg shadow-lg p-4 sm:p-6 w-72 sm:w-[50rem] text-left"
        ...
        >
          <div className="flex flex-col items-start space-x-2">
            <PiSparkleFill className="text-green-900 mt-4 text-lg" />
            <div>
              ...
              <p className="text-gray-700 text-[3.5vw] sm:text-[1.2vw] leading-relaxed mb-4">
                ...
                <br /> <br />
                JaGoCoach’s tools bespoke and simple, and impact is lasting.
                Just real, confidentiality assured conversations, practical
                shifts, and emotional precision. This is coaching for humans who
                want to rise — not rush. Reflect — not retreat. And design a
                life that feels true. Real talk. Simple practices. Big shifts.
                This isn’t therapy. It’s ignition — with a spark of soul and a
                dash of strategy.
              </p>
            </div>
          </div>
