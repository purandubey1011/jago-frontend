  ...
  return (
    ...
    >
      ...
      <motion.div variants={imageVariants} className="relative">
        ...
        <img
          src="https://images.unsplash.com/photo-1639162097596-212d00e5bca1?q=80&w=1074&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
          alt="About Jago"
      ...
      <div className="flex flex-col gap-6 max-w-[600px] px-2 sm:px-0">
        ...
        <motion.h2 variants={contentChildVariants} className="text-3xl md:text-4xl font-bold leading-snug text-gray-900">
          Arise. Awake. Achieve<br /> 
          JaGoCoach is your partner in <br /> clarity 
          and growth.
        </motion.h2>

        {/* Subtext */}
        <motion.p variants={contentChildVariants} className="text-gray-600 text-base leading-relaxed ">
          JaGo means Awaken. JaGoCoach is a call to awaken. Whether you’restuck, curious, or ready to level up — JaGoCoach is your ignition. Transform yourself and benefit from timeless insights — from MentalPhysics, Certified Coaching, Breathwork, Reiki, and proven Psychological Frameworks — into modern clarity. Cut through the noise. Reconnect with purpose. Design a life that feels true. This isn’t therapy. It’s ignition.
        </motion.p>
